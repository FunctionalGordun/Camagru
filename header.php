			...
			<nav class="navigation_bar">
				...
				<li class="nav_link profile">
					<div class="profile_block">
						<div class="small_phot">
							<button onclick="myFunction()" class="dropbtn"></button>
							<?php if (isset($_COOKIE['user'])):
									$info = get_prof_info();
									$show_img = base64_encode($info['prof_pic']);
									if ($show_img != NULL):?>
										<img class="small_prof_img" src="data:image/jpeg;base64, <?= $show_img ?>" alt="profile">
									<?php endif; ?>
							<?php else: ?>
